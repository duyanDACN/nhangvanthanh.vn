...
$fake_comment = get_field('fake_comment');
$fake_cart = get_field('fake_cart');
			...
			<?php
                ...
                <span>       
		            ...
		            <i class="icon-star" aria-hidden="true"></i>
		                    ...
		                    <ins>( <?php //echo $fake_comment; ?>)</ins>
		                </span>
		                <label><?php //echo $fake_cart; ?> <i class="icon-shopping-bag"></i></label>
		            </!-- -->
				<?php
